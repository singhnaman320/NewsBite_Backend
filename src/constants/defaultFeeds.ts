...
export const defaultFeeds: DefaultFeed[] = [
  ...
  },
  {
    ...
    description:
      "Extensive global coverage, investigations, and analysis from the NYT.",
  ...
  },
  {
    ...
    description:
      "International top stories and breaking news updates from CNN.",
    fetchIntervalMinutes: 15,
  },
  {
    ...
    description:
      "The latest on technology, startup funding, and venture capital.",
    fetchIntervalMinutes: 15,
  },
  {
    ...
    description:
      "In-depth articles covering the intersection of technology, science, and art.",
    fetchIntervalMinutes: 20,
  },
  {
    sourceName: "Wired",
  ...
  },
  {
    ...
    category: "Top News",
    rssUrl:
      "https://search.cnbc.com/rs/search/combinedcms/view.xml?profile=120000000&id=100003114",
    description: "Latest business and financial news updates.",
    fetchIntervalMinutes: 15,
  },
];

export const availableTopics = Array.from(
  new Set(defaultFeeds.map((feed) => feed.topic)),
);
